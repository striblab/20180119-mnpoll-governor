# Star Tribune - Minnesota Poll 2018: Governor's race
...
1. Get code and enter project: `git clone https://github.com/striblab/20180119-mnpoll-governor.git && cd 20180117-mnpoll-taxes.git`
...
2. Copy files (update path as needed): `mkdir -p ../20180119-mnpoll-governor/ && rsync -rav ./ ../20180119-mnpoll-governor/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
